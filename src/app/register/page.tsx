...
// ── Translations ──────────────────────────────────────────────
const LANGS = {
    PT: { title: "Crie sua conta", subtitle: "Comece a controlar suas finanças hoje", labelName: "Nome completo", namePlaceholder: "João da Silva", loginMethod: "Método de acesso", phone: "📱 Telefone", email: "✉️ E-mail", labelPhone: "Número de Telefone", phonePlaceholder: "(11) 99999-9999", labelEmail: "E-mail", emailPlaceholder: "voce@exemplo.com", labelPassword: "Senha", passwordPlaceholder: "Mínimo 8 caracteres", labelConfirm: "Confirmar senha", confirmPlaceholder: "Repita a senha", profileType: "Tipo de perfil", personal: "🏠 Pessoal", business: "🏢 Empresarial", terms: "Concordo com os", termsLink: "termos de uso", and: "e a", privacyLink: "política de privacidade", registerBtn: "Criar conta", hasAccount: "Já tem uma conta?", login: "Entrar →", searchCountry: "Buscar país...", noCountry: "Nenhum país encontrado", weak: "Fraca", fair: "Razoável", good: "Boa", strong: "Forte" },
    EN: { title: "Create your account", subtitle: "Start controlling your finances today", labelName: "Full name", namePlaceholder: "John Smith", loginMethod: "Access method", phone: "📱 Phone", email: "✉️ E-mail", labelPhone: "Phone Number", phonePlaceholder: "(11) 99999-9999", labelEmail: "E-mail", emailPlaceholder: "you@example.com", labelPassword: "Password", passwordPlaceholder: "Minimum 8 characters", labelConfirm: "Confirm password", confirmPlaceholder: "Repeat password", profileType: "Profile type", personal: "🏠 Personal", business: "🏢 Business", terms: "I agree to the", termsLink: "terms of service", and: "and the", privacyLink: "privacy policy", registerBtn: "Create account", hasAccount: "Already have an account?", login: "Sign in →", searchCountry: "Search country...", noCountry: "No countries found", weak: "Weak", fair: "Fair", good: "Good", strong: "Strong" },
    ES: { title: "Crea tu cuenta", subtitle: "Empieza a controlar tus finanzas hoy", labelName: "Nombre completo", namePlaceholder: "Juan García", loginMethod: "Método de acceso", phone: "📱 Teléfono", email: "✉️ Correo", labelPhone: "Número de Teléfono", phonePlaceholder: "(11) 99999-9999", labelEmail: "Correo electrónico", emailPlaceholder: "tu@ejemplo.com", labelPassword: "Contraseña", passwordPlaceholder: "Mínimo 8 caracteres", labelConfirm: "Confirmar contraseña", confirmPlaceholder: "Repite la contraseña", profileType: "Tipo de perfil", personal: "🏠 Personal", business: "🏢 Empresarial", terms: "Acepto los", termsLink: "términos de servicio", and: "y la", privacyLink: "política de privacidad", registerBtn: "Crear cuenta", hasAccount: "¿Ya tienes cuenta?", login: "Iniciar sesión →", searchCountry: "Buscar país...", noCountry: "Ningún país encontrado", weak: "Débil", fair: "Regular", good: "Buena", strong: "Fuerte" },
} as const;

type LangKey = keyof typeof LANGS;

const COUNTRIES = [
    { code: "BR", name: "Brasil", dial: "+55", flag: "🇧🇷" }, { code: "US", name: "United States", dial: "+1", flag: "🇺🇸" }, { code: "PT", name: "Portugal", dial: "+351", flag: "🇵🇹" }, { code: "AR", name: "Argentina", dial: "+54", flag: "🇦🇷" }, { code: "ES", name: "España", dial: "+34", flag: "🇪🇸" }, { code: "FR", name: "France", dial: "+33", flag: "🇫🇷" }, { code: "DE", name: "Deutschland", dial: "+49", flag: "🇩🇪" }, { code: "GB", name: "United Kingdom", dial: "+44", flag: "🇬🇧" }, { code: "IT", name: "Italia", dial: "+39", flag: "🇮🇹" }, { code: "MX", name: "México", dial: "+52", flag: "🇲🇽" }, { code: "JP", name: "日本", dial: "+81", flag: "🇯🇵" }, { code: "CA", name: "Canada", dial: "+1", flag: "🇨🇦" }, { code: "AU", name: "Australia", dial: "+61", flag: "🇦🇺" }, { code: "AO", name: "Angola", dial: "+244", flag: "🇦🇴" },
];
...
export default function RegisterPage() {
    ...
    // SOLUÇÃO: Pega o e-mail da URL usando JavaScript puro, sem o Next.js
    useEffect(() => {
