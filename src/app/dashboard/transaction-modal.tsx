...
export default function TransactionModal({
    type, workspaceId, categories, accounts, userName, onClose, onSaved,
}: Props) {
    ...
    const [notPaid, setNotPaid] = useState(true);   // "Não foi pago/recebido"
    const [dueDate, setDueDate] = useState(new Date().toISOString().slice(0, 10));
    const [competDate, setCompetDate] = useState(new Date().toISOString().slice(0, 10));
